    ...
    def train(self):
        ...
        for i in scenarios:
            ...
            for run_id in range(self.num_runs):  # specify number of consecutive runs
                ...
                model_t_name = os.path.join(self.save_dir,self.dataset,'DANN_CNN_teacher\Archive',best_teacher)
...
parser.add_argument('--experiment_description', default='EEG',               type=str, help='Name of your experiment (EEG, HAR, HHAR_SA, FD')
parser.add_argument('--run_description',        default='AAD',                     type=str, help='name of your runs, ')

# ========= Select the DA methods ============
parser.add_argument('--da_method',              default='AAD',               type=str, help='MobileDA, AAD')

# ========= Select the DATASET ==============
parser.add_argument('--data_path',              default=r'./data',                  type=str, help='Path containing dataset')
parser.add_argument('--dataset',                default='EEG',                      type=str, help='Dataset of choice: (FD - EEG - HAR - HHAR_SA)')
