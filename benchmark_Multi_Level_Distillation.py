    ...
    def train(self):
        ...
        for i in scenarios:
            ...
            for run_id in range(self.num_runs):  # specify number of consecutive runs
                ...
                model_t_name = os.path.join(self.save_dir,self.dataset,'DANN_CNN_teacher',best_teacher)
                ...
                # Pre-train student with src + tgt
                for epoch in range(1, self.hparams["num_epochs"] + 1):
                    ...
                    for step, ((src_x, src_y), (trg_x, _)) in joint_loaders:
                        ...
                        losses = algorithm.update_s_both(src_x, src_y, trg_x)
                ...
                for epoch in range(1, self.hparams["num_epochs"] + 1):
                    ...
                    for step, ((src_x, src_y), (trg_x, _)) in joint_loaders:
                        ...
                        losses = algorithm.update_s_tgt(src_x, src_y, trg_x)
...
parser.add_argument('--run_description',        default='MLD',                     type=str, help='name of your runs')

# ========= Select the DA methods ============
parser.add_argument('--da_method',              default='MLD',               type=str, help='JointADKD')
